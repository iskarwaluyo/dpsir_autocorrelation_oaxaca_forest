...
pal_maderable <- colorBin( palette="viridis", domaster = ac_mapa_maderable$VPM_2016, bins = bins_vpm)
pal_no_maderable <- colorBin( palette="viridis", domaster = ac_mapa_maderable$VPNM_2016, bins = bins_vpnm)
pal_agricola <- colorBin( palette="viridis", domaster = ac_mapa_agricola$VPC_2016, bins = bins_vpc)
pal_ganadera <- colorBin( palette="viridis", domaster = ac_mapa_ganadera$VPT_2016, bins = bins_vpt)

pal_prod_maderable <- colorBin(palette="magma", domaster = ac_mapa_maderable$APM_2016, bins = bins_vpm)
pal_prod_no_maderable <- colorBin(palette="magama", domaster = ac_mapa_maderable$APNM_2016, bins = bins_vpnm)
