              ...
              navbarPage("DPSIR OAXACA", 
                         ...
                         navbarMenu("Mapas",
                          ...
                          tabPanel("Drivers",
                                  ...
                                  absolutePanel(top = 10, right = 10, checkboxInput("leyenda_driver", "Mostrar leyenda", FALSE),
                         ...
                         tabPanel("Pressure",
                                  div(class="outer",
                                      ...
                                      absolutePanel(top = 10, right = 10, checkboxInput("leyenda_pressure", "Mostrar leyenda", FALSE),
                                                    absolutePanel(id = "logo_tia_cony", class = "card", bottom = 20, left = 60, width = "100%", 
                                                                  fixed=TRUE, draggable = FALSE, height = "auto", 
                                                                  tags$a(href='https://www.conacyt.gob.mx', 
                                                                         tags$img(src='https://raw.githubusercontent.com/iskarwaluyo/mapa_agricultura_masaforestal/master/html/logo_conacyt_solo.png',height='40',width='40'))),
                         ...
                         tabPanel("State",
                                  div(class="outer",
                                      ...
                                      absolutePanel(top = 10, right = 10, checkboxInput("leyenda_state", "Mostrar leyenda", FALSE),
                                                    absolutePanel(id = "logo_tia_cony", class = "card", bottom = 20, left = 60, width = "100%", 
                                                                  fixed=TRUE, draggable = FALSE, height = "auto", 
                                                                  tags$a(href='https://www.conacyt.gob.mx', 
                                                                         tags$img(src='https://raw.githubusercontent.com/iskarwaluyo/mapa_agricultura_masaforestal/master/html/logo_conacyt_solo.png',height='40',width='40'))),
                         ...
                         tabPanel("Impact",
                                  div(class="outer",
                                      ...
                                      absolutePanel(top = 10, right = 10, checkboxInput("leyenda_impact", "Mostrar leyenda", FALSE),
                                                    absolutePanel(id = "logo_tia_cony", class = "card", bottom = 20, left = 60, width = "100%", 
                                                                  fixed=TRUE, draggable = FALSE, height = "auto", 
                                                                  tags$a(href='https://www.conacyt.gob.mx', 
                                                                         tags$img(src='https://raw.githubusercontent.com/iskarwaluyo/mapa_agricultura_masaforestal/master/html/logo_conacyt_solo.png',height='40',width='40'))),
                         ...
                         tabPanel("Response",
                                  div(class="outer",
                                      ...
                                      absolutePanel(top = 10, right = 10, checkboxInput("leyenda_response", "Mostrar leyenda", FALSE),
                                                    absolutePanel(id = "logo_tia_cony", class = "card", bottom = 20, left = 60, width = "100%", 
                                                                  fixed=TRUE, draggable = FALSE, height = "auto", 
                                                                  tags$a(href='https://www.conacyt.gob.mx', 
                                                                         tags$img(src='https://raw.githubusercontent.com/iskarwaluyo/mapa_agricultura_masaforestal/master/html/logo_conacyt_solo.png',height='40',width='40'))),
